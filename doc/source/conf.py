...
sphinx_gallery_conf = {
    ...
    'expected_failing_examples': ['../examples/example.py']
}
...
project = 'scola'
copyright = '2018-{}, Sadamori Kojaku'.format(date.today().year)
...
modindex_common_prefix = ['scola.']

doctest_global_setup = "import scola"
...
html_use_opensearch = 'http://sadamori.koujaku'

# Output file base name for HTML help builder.
htmlhelp_basename = 'scola'
