...
def generate_network(C_samp, L, null_model="all", disp=True):
    ...
    null_model : str, default 'all'
        ...
        or the configuration model (null_model='config').
        If null_model='all', then the best one among the three null models in terms of the extended Bayes information criterion (BIC) is selected.
    disp : bool, default True
        Set disp=True to display the progress of the computation.
